...
namespace Axis.Pollux.Notification.Client.EF.Mappings
{
    public class NotificationMapping : BaseMap<long, ClientNotificationEntity, Models.Notification>
    {
        public NotificationMapping()
        : base(false)
        {
            this.ToTable(nameof(ClientNotificationEntity).Replace("Entity", ""));
        ...
        public override void CopyToEntity(Models.Notification model, ClientNotificationEntity entity, ModelConverter converter)
        {
        ...
        public override void CopyToModel(ClientNotificationEntity entity, Models.Notification model, ModelConverter converter)
        {
