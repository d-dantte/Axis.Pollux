...
{
    public class OperationAuthority : IOperationAccessAuthority
    {
        ...
        public OperationAuthority(IUserContext userContext, IServiceResolver resolver)
        {
        ...
        => LazyOp.Try(() =>
        {
            ...
            .Then(_permissions =>
            {
                ...
                _permissions
                    ...
                    .Where(_p => _p.Context == "*" || _p.Context == descriptor.Context)
                    .Select(_p => _p.Effect)
                    .Combine()
